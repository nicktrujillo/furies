...
// const Action = ({ addLike, z, removeLike, comments, auth, user }) => {
//   return (
//     <>
//       <button onClick={() => addLike(z)} type='button' className='postButton'>
//         <i className='fas fa-thumbs-up' />{" "}
//         <span>{likes.length > 0 && <span>{likes.length}</span>}</span>
//       </button>
//       <button
//         onClick={() => removeLike(z)}
//         type='button'
//         className='postButton'
//       >
//         <i className='fas fa-thumbs-down' />
//       </button>
//       <Link to={`/posts/` + z} className='postButton'>
//         Discussion{" "}
//         {comments.length > 0 && (
...
//   const soundcloudOne = "https://w.soundcloud.com/player/?url=";
//   const soundCloudThree = "?//api.soundcloud.com/tracks/293";
//   const { addLike, removeLike, deletePost, auth, post, showActions } = props;
//   const {
//     text,
//     soundcloud,
//     youtube,
