...
function Youtube() {
  ...
  return (
    <>
      {showForm ? (
        <div className='infoPagePaypalButtons'>
          <FormService price={price} product={product} />
        </div>
      ) : (
        <div className='youtubePageContainer'>
              ...
              <div className='wrapper2'>
                <div className='pricing_wrapper'>
                  ...
                  >
                    ...
                    <button className='product-price-btn' type='submit'>
                      Buy now{" "}
                    </button>
                  </div>
                  <div
                    onClick={() =>
                      handleClick("40", "YouTube Standard Promotion")
                    }
                    className='pricing_item'
                  >
                  ...
                  <div
                    onClick={() =>
                      handleClick("50", "YouTube Premium Promotion")
                    }
                    className='pricing_item'
                  >
          ...
          <div className='bottom-container right-info'>
            ...
            <p>
              Once you have placed your order, our team will prepare your ads
              and launch the promotion campaign on Youtube according to your
              preferences. Keep in mind you only pay for real views when viewers
              actually watched your video ad in its entirety or after 30
              seconds, whichever comes first. The viewers have the option to
              skip an ad after 5 seconds but money will not be charged when they
              skip. When the promotion ends, you will receive a detailed report
